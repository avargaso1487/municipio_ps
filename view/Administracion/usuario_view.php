						...
						<div class="row">
							<div class="col-md-12">								
								<div class="table-header">
									Lista de Colaboradores con Usuario &nbsp;&nbsp;
									...
									<table id="tablaUsuarios" class="table table-striped table-bordered">
										<thead>											
								            <tr>								                
								                ...
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 9%;">CREACIÓN</th>
								                <th style="text-align: center; font-size: 11px; height: 10px; width: 8%;">CESE</th>
					...
					<div class="modal-dialog" style="width: 40% !important;">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h3 class="blue bigger">DATOS DEL USUARIO DEL COLABORADOR</h3>
							</div>
								...
								<div class="modal-body">
									<div class="row">
										<div class="modal-body col-md-12">
											...
											<div class="form-group col-md-12" id="colaborador">
												<label for="param_usuarioColaborador">Colaborador</label>
												<div id="grupo">
													<div class="input-group col-md-12">														
														<select class="form-control" id="param_usuarioColaborador" name="param_usuarioColaborador">
